            ...
            <nav>
                <div className='left'>
                    ...
                    <div className='navlogo'>
                        <NavLink to='/'><img src={require("../Images/Amazon-Logo-Download-PNG-Image.png")} alt='' /></NavLink>
                    </div>
                ...
                <div className='right'>
                    ...
                    >
                        ...
                        {
                            account ? <MenuItem onClick={handleClose} onClick={logoutuser}><LogoutIcon style={{ fontSize: "16px", marginRight: "3px" }} />Logout</MenuItem> : ""
